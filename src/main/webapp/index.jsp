    ...
    <div class="container">
      ...
      <nav class="nav-menu mobile-menu">
        <ul>
          ...
          <li><a href="./shop.html">강의</a>
            <ul class="dropdown">
              <li><a href="#">선생님 정보</a></li>
            </ul>
          </li>
          <li><a href="#">선생님</a>
            <ul class="dropdown">
          ...
          <li><a href="./blog.html">나의 학습방</a>
            <ul class="dropdown">
              <li><a href="./blog-details.html">나의 강의실</a></li>
              <li><a href="./shopping-cart.html">내가 쓴 글</a></li>
              <li><a href="./check-out.html">내가 남긴 댓글</a></li>
              <li><a href="./faq.html">성적표</a></li>
