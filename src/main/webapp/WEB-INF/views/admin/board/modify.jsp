    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <div class="pd-20 card-box mb-30" style="margin-bottom: 30px">
            ...
            <div id="list">
                ...
                <hr>
                <br>
                <form name="frmRegist" action="/admin/board/modify" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex align-items-start align-items-sm-center mt-3 w-50">
                        <input class="form-control" name="bbs_title" type="text" value="${bbs.bbs_title}" placeholder="제목을 입력해주세요.">
                    </div>
                    <br>
                    <div>
