        ...
        <div id="leftNav">
            <nav class="nav flex-column">
                ...
                <div style="padding-top: 20px; line-height: unset;">
                    ...
                    <a class="nav-link" href="/lecture/noticeList?lecture_idx=${list.lecture_idx}">공지사항</a>
                    <a class="nav-link" href="/lecture/qnaList?lecture_idx=${list.lecture_idx}">Q&A</a>
                    <a class="nav-link" href="/lecture/jalyosilList?lecture_idx=${list.lecture_idx}">자료실</a>
        ...
        <div class="product-tab" id="list">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>90</td>
                    <td style="width: 150px;"><button type="button" class="btn" data-idx="" id="view" data-bs-toggle="modal" data-bs-target="#exampleModal">성적표입력</button></td>
                </tr>
                </tbody>
            </table>
            <%--        성적표 모달창--%>
